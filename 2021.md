...
# 工作经历
## 新思半导体科技(上海)有限公司(2021-03 ~ 至今)
### 职位:高级开发工程师
### 工作内容
- 负责分析公司内部测试工具的log,抓取有用信息存库
- 根据上述测试数据作数据统计分析
### 工作项目
### Portal
#### 项目介绍
该项目是公司内部使用的一个数据分析平台。通过抓取公司各种测试软件的测试结果以及日志。用 Web 形式展现出来。工作的难点在于大量数据处理的速度控制以及最终展示页面的sql优化。
#### 使用技术
- 服务端:Perl/Python/php/Redis
- 前端:Vue/Jquery/Js
#### 为什么有换工作的打算?
相信很多的面试官看到这个很短的工作经历都会有这样的疑问。主要原因是所在team 非公司的核心team.而且开发的产品用户较少，缺少成就感。
## 每步科技上海有限公司 （ 2015年10月 ~ 2021-03 ）
### 职位:研发经理
### 工作内容
- 对接需求提出方,提供项目的可行性分析以及优化意见;
- 负责开发系统的需求调研/PRD制作/系统开发和数据库设计;
